...
// ... (rest of the script.js content is here)

// Around line 520 (in the fetched content context):
// ...
// const royalDeparture = fields[FIELD_NAMES.ROYAL_DEPARTURE]; // ... other detail vars
// ...
...
let fieldMappings = [
    ...
    { label: `<span class="status-circle" style="background-color: ${getStatusColor(fields[FIELD_NAMES.GUEST_ARRIVAL], fields[FIELD_NAMES.GUEST_DEPARTURE])};"></span> جناح ضيافة - الوصول`, value: fields[FIELD_NAMES.GUEST_ARRIVAL] }, // <-- MODIFIED GUEST ARRIVAL
    { label: 'جناح ضيافة - المغادرة', value: fields[FIELD_NAMES.GUEST_DEPARTURE] },
    { label: 'جناح VIP - عدد الغرف', value: fields[FIELD_NAMES.VIP_COUNT] }, // <-- MODIFIED VIP COUNT (removed circle)
    { label: `<span class="status-circle" style="background-color: ${getStatusColor(fields[FIELD_NAMES.VIP_ARRIVAL], fields[FIELD_NAMES.VIP_DEPARTURE])};"></span> جناح VIP - الوصول`, value: fields[FIELD_NAMES.VIP_ARRIVAL] }, // <-- MODIFIED VIP ARRIVAL
    { label: 'جناح VIP - المغادرة', value: fields[FIELD_NAMES.VIP_DEPARTURE] },
    { label: 'جناح ملكي - عدد الغرف', value: fields[FIELD_NAMES.ROYAL_COUNT] }, // <-- MODIFIED ROYAL COUNT (removed circle)
    { label: `<span class="status-circle" style="background-color: ${getStatusColor(fields[FIELD_NAMES.ROYAL_ARRIVAL], fields[FIELD_NAMES.ROYAL_DEPARTURE])};"></span> جناح ملكي - الوصول`, value: fields[FIELD_NAMES.ROYAL_ARRIVAL] }, // <-- MODIFIED ROYAL ARRIVAL
